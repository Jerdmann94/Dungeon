...
public class GameEnemyMovementRequestListener : MonoBehaviour
{
    ...
    public void OnEventTriggered(Vector3 pos, List<PlayerThreat> threatTable, string enemyId,bool isRanged)
    {
        onEventTriggered.Invoke(pos, threatTable, enemyId,isRanged);
    }
}
