...
public class AITileMove : MonoBehaviour, IAstarAI
{
    ...
    public void Update()
    {
        ...
        if (path == null) // We have no path to follow yet, so don't do anything
            return;
        ...
        var dir = (path.vectorPath[currentWaypoint] - position).normalized;
