...
public class EconomyManager : MonoBehaviour
 {
        ...
        public async Task RefreshCurrencyBalances()
        {
            ...
            {
                balanceResult = await EconUtil.RetryEconomyFunction(GetEconomyBalances, e.RetryAfter);
            }
            catch (Exception e)
            {
        ...
        public async Task RefreshInventory()
        {
            ...
            {
                inventoryResult = await EconUtil.RetryEconomyFunction(GetEconomyPlayerInventory, e.RetryAfter);
            }
            catch (Exception e)
            {
